...
serie_temporal |> index_by(trimestre) |> summarise(median_MA = median(MA)) |> autoplot(median_MA) + 
  labs(title="Preço mediano da série agregada", y="Preço mediano") + theme_minimal()

serie_temporal |>
  autoplot(MA) +
  labs(title = "Preço mediano por tipo e número de quartos", y = "Preço mediano") + theme_minimal()
